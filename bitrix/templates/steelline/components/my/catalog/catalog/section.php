...
$GLOBALS['arrFilter']['PROPERTY_STYLE_DVERI_VALUE'] = $_GET["STYLE_DVERI"];
$GLOBALS['arrFilter']['PROPERTY_TAGS_VALUE'] = $_GET["TAGS"];
$GLOBALS['arrFilter']['PROPERTY_SPECIAL_VALUE'] = $_GET["filter"]["SPECIAL"];
$GLOBALS['arrFilter']['PROPERTY_BASE_EQUIPMENT'] = $_GET["TINER"];
$GLOBALS['arrFilter']['PROPERTY_IN_STOCK_VALUE'] = $_GET["filter"]["IN_STOCK"];

if(strpos($APPLICATION->GetCurUri(), "/catalog-dverei/staraya-kollektsiya") !== 0) {
