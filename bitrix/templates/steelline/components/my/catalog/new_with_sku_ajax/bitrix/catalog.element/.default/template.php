...
<div class="cool_item<? if ($sample) { ?> sample_card<? } ?><?= $class ?>" itemscope itemtype="http://schema.org/Product">
            ...
            if (!$sample && $arResult["PROPS"]["MAIN"]) {
                ...
                <div class="params">
                    <?php foreach ($arResult["PROPS"]["MAIN"] as $val) { ?>
                        <p itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue"><span itemprop="name" ><?php echo $val["NAME"]; ?></span><b itemprop="value"><?php
            ...
            if (!empty($arResult["OFFERS"])) {
                ...
                <ul class="sets clearfix">
                    ...
                    <?php foreach ($arResult["OFFERS"] as $k => $arOffer) { ?>
                        <li data-offerId="<?= $arOffer["ID"] ?>" data-door="<?php echo $k; ?>" class="clearfix fll" data-price="<?php echo $arOffer["MIN_PRICE"]["VALUE"] ?>"
                            ...
                            >
                                ...
                                <span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
                                    <span itemprop="priceSpecification" itemscope itemtype="http://schema.org/UnitPriceSpecification">
                                        ...
                                        <?php if ($arOffer["MIN_PRICE"]["VALUE"] > $arOffer["MIN_PRICE"]["DISCOUNT_VALUE"]) { ?>
                                            <meta itemprop="minPrice" content="<?php echo $arOffer["MIN_PRICE"]["DISCOUNT_VALUE"]; ?>">
                                        <?php } ?>
                                    </span>
                                </span>
                                <div class="img fll">
                                    <div class="td" itemprop="image" itemscope itemtype="http://schema.org/ImageObject"><img src="<?php echo $arOffer["DETAIL_PICTURES"][0]["SRC"]; ?>" alt="<?php echo $arOffer["DETAIL_PICTURES"][0]["ALT"] ?>" class="js_img" itemprop="contentUrl"><meta itemprop="caption" content="<?php echo $arOffer["DETAIL_PICTURES"][0]["ALT"] ?>"></div>
                                </div>
                                <div class="img flr">
                                    <div class="td" itemprop="image" itemscope itemtype="http://schema.org/ImageObject"><img src="<?php echo $arOffer["DETAIL_PICTURES"][1]["SRC"]; ?>" alt="<?php echo $arOffer["DETAIL_PICTURES"][1]["ALT"]; ?>" class="js_img" itemprop="contentUrl"><meta itemprop="caption" content="<?php echo $arOffer["DETAIL_PICTURES"][1]["ALT"]; ?>"></div>
                                </div>
                                <?php
                            }
                            if ($arOffer["TOOLTIP"]["ARTICLE"] || $arOffer["TOOLTIP"]["OUTSIDE"] || $arOffer["TOOLTIP"]["INSIDE"]) {
                                ...
                                <div class="tooltip js_info">
                                    ...
                                    <?php if ($arOffer["TOOLTIP"]["OUTSIDE"]) { ?>
                                        <p class="js_out" itemprop="color"><?php echo getMessage("OUT"); ?><?php echo $arOffer["TOOLTIP"]["OUTSIDE"] ?></p>
                                    <?php } ?>
                                    <?php if ($arOffer["TOOLTIP"]["INSIDE"]) { ?>
                                        <p class="js_in" itemprop="color"><?php echo getMessage("IN"); ?><?php echo $arOffer["TOOLTIP"]["INSIDE"] ?></p>
                                    <?php } ?>
                                </div>
                            <?php } ?>
                        </li>
            ...
            <? if (!$sample) { ?>
                <div class="clearfix">
                    ...
                    <p class="salons fll carts credit-wrap">
                        ...
                        <a class="halva js_installments_cards"><span class="credit" data-card="<?php echo getMessage("CREDIT_HALVA"); ?>" data-credit="<?= $halva?>"><?php echo getMessage("CREDIT_HALVA");?></span></a><br>
                        <a class="karta_pokupok js_installments_cards"><span class="credit" data-card="<?php echo getMessage("CREDIT_MAP_BUY"); ?>" data-credit="<?= $card_pokupok?>"><?php echo getMessage("CREDIT_MAP_BUY"); ?></span></a><br>
                        <a class="smart_karta js_installments_cards"><span class="credit" data-card="<?php echo getMessage("CREDIT_SMART_CARD"); ?>" data-credit="<?= $card_smart?>"><?php echo getMessage("CREDIT_SMART_CARD"); ?></span></a>
                    ...
                    <p class="salons fll carts_message hidden">Рассрочка <br>не распростаняется <br>на акционные двери.</p>

                    <p class="salons fll carts_delivery">
                        <?php echo getMessage("DELIV"); ?>
                        <a href="/dostavka-i-ustanovka/" target="_blank"><span><?php echo getMessage("DELIV_TEXT"); ?></span></a>
                    </p>
                ...
                <div class="clearfix">
                    ...
                    <div class="manager_call hidden">
                        <a href="#" class="button_white" data-toggle="modal" data-target="#managerCallModal">Заказать звонок</a>
                ...
                <div class="sample_description">
                    ...
                    <? if ($arResult["MAP"]["ID"]) { ?>
                        <p class="sample_description_address">
                            ...
                            <a href="/gde_kupit/?salon=<?php echo $arResult["MAP"]["ID"] ?>" target="_blank"><?php echo $arResult["MAP"]["ADDRESS"] ?></a>
                        </p>
                    <? } ?>
                </div>
            <? } ?>
                                ...
                                <?php foreach ($offerProps as $property) { ?>
                                    <tr itemprop="additionalProperty" itemscope itemtype="http://schema.org/PropertyValue">
                                        <?php foreach ($arResult["THEAD"][$code] as $l => $title) { ?>
                                            <td <?php if ($l == 0) { ?>itemprop="name"<?php } else { ?>itemprop="value"<?php } ?> ><?php echo $property[$title] ?></td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
                            </table>
    ...
    <? if (!$sample) { ?>
        <div class="description wrap new clearfix">
            ...
            <div class="text fll" itemprop="description">
                ...
                <div class="dp-safery-plahka"><a class="dp-safery-plahka__body dp-block-link" href="/bezopasnost"><span class="dp-safery-plahka__title">Безопасность</span><span class="dp-safery-plahka__desc">Расскажем, как дверь защищает <br/> от разных видов взлома.</span></a></div>
            </div>
    ...
    <div class="modal_bg">
        <div class="modal_content installments halva">
            ...
            <div class="modal_body">
                ...
                <p class="installment_clause"><span class="exclamation modal_exclamation">!</span>Рассрочка действует на все входные двери, кроме образцов и&nbsp;акционных моделей</p>
            </div>
        ...
        <div class="modal_content installments karta_pokupok">
            ...
            <div class="modal_body">
                <p class="bank_program_descr">При покупке двери в фирменном салоне вы самостоятельно определяете сумму платежа по&nbsp;карте — от 30&thinsp;% до&nbsp;100&thinsp;%. Оставшаяся часть вносится равными долями до 20 числа в течение 12 последующих месяцев.</p>
