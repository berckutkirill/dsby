...
<div class="constructor">
			<div class="wrap clearfix">
				...
				<div class="content">
					...
					<div class="block">
						<div class="hidden line homeCheck clearfix">
						...
						<div class="hidden line clearfix">
						...
						<div class="hidden line clearfix" id="model">
							...
							<div class="select_list" data-f="MODELD">
								...
								<ul id="modelList">
									...
									if($base == $val["ITEM_ID"]) {$class="selected";} else {$class="";}
									?>
										<li data-text="<?=$val["VALUE"]?>" data-excel="MODELD" data-excel-val="<?=$val["VALUE"]?>" class="<?=$class?>" data-price="<?=$val["BASE_PRICE"]?>" data-value="<?=$val["VALUE_ID"]?>"><?=$val["VALUE"]?><span><?=$val["BASE_PRICE"]?></span></li>
									<? } ?>
								</ul>
							</div>
						</div>

						<div class="hidden line ajax clearfix closest_name_wrap closest_pricer" id="secondAjax"  data-filter="TOL">
				...
				<div class="ajax" id="thirdAjax">
					...
					<div class="block closest_pricer">
						...
						<div class="line closest_name_wrap clearfix">
							...
							?>
								<b data-input="KONTUR" class="radio_but <?=$check?> mini" data-excel="KONTUR" data-excel-val="<?=$val["VALUE"]?>" data-radio="<?=$radio?>" data-price="<?=$val["PRICE"]?>" data-value="<?=$val["VALUE_ID"]?>"><?=$val["VALUE"]?></b>
							<? } $checked = false; $radio++;?>
						</div>
					</div>
						...
						<div class="clearfix">
							...
							<?foreach($Filter["FURNS"] as $k => $furn) {
							 ...
							 ?>
								...
								<div class="furn_type <?=$furn["ID"]?>" data-f="toggleShow" data-toggle="#furn_type<?=$k?>">
									<div class="line clearfix">
										<b class="slide_down"></b>
										<b data-input="FURN" class="radio_but <?=$check?>" data-radio="<?=$radio?>"><?=$furn["NAME"]?></b>
								...
								<div class="screen closest_switcher">
									...
									?>
										<p class="radio switcher_set" data-id="hand_col<?=$key?>">
											<span data-input="HAND" class="radio_box <?=$check." ".$excel?>" data-price="<?=$val["PRICE"]?>" data-excel="HAND" data-excel-val="<?=$val["VALUE"]?>"  data-radio="<?=$radio?>" data-f="toggleShow" data-toggle="hand_colors<?=$key?>"><?=$val["NAME"]?></span>
		...
		<div class="wrap">
				<div class="end_constr">
					<button class="addZayavka" type="submit">Добавить в заявку</button>
				</div>
			</div>
