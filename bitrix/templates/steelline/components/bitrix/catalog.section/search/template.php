...
<section class="carts res">
			<div class="wrap">
				...
				<p class="not_found">Не нашли, что искали? Попробуйте ввести другой запрос</p>
				<form class="search_form"><input name="q" value="<?=htmlspecialchars($_GET["q"])?>"><button type="submit"></button></form>
				<div class="list">
					<ul>
