        ...
        <div class="c-tab__main">
            <div class="c-tab__body">
                <div class="c-tab__title c-h4">
                    <h4 class="c-tab__price active">+405 руб.</h4>
                    <h4 class="c-tab__price">+513 руб.</h4>
                </div>
                
                <p class="c-tab__text c-tab__toggle c-p2">Замок имеет два механизма секретности в одном корпусе. Предусмотрено зависимое запирание обоих механизмов: при&nbsp;закрытии цилиндрового замка, верхнее отверстие для&nbsp;ключа перекрывает металлическая шторка.
            ...
            <div class="c-tab__foot c-p2">
                <div class="c-tab__data">
                    <ul class="c-tab__data-item">
                        ...
                        <li class="c-tab__data-title"><a class="c-link" href="/zamki#mottura_54">Mottura 54.797</a></li>
                    </ul>
                    <ul class="c-tab__data-item">
