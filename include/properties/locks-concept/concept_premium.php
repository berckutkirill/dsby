<li class="c-tabs__item <?= !$arParams["DATA_TAB"] ? "c-tabs__item--active" : "" ?>">   
    <div class="c-tab c-tab--trigger">
            ...
            <div class="c-tab__foot c-p2">
                <div class="c-tab__data">
                    <ul class="c-tab__data-item">
                        ...
                        <li class="c-tab__data-title"><a class="c-link" href="/zamki#iseo_608_DFP">Iseo 608 DFP</a></li>
                    </ul>
                    <ul class="c-tab__data-item">
        ...
        <img class="c-tab__img" src="<?= SITE_TEMPLATE_PATH ?>/img/concept/2x/lock-premium.png" srcset="<?= SITE_TEMPLATE_PATH ?>/img/concept/1x/lock-premium.png 1x, <?= SITE_TEMPLATE_PATH ?>/img/concept/2x/lock-premium.png 2x"/>
    </div>
</li>