<li class="c-tabs__item <?= !$arParams["DATA_TAB"] ? "c-tabs__item--active" : "" ?>">   
    <div class="c-tab c-tab--trigger">
            ...
            <div class="c-tab__foot c-p2">
                <div class="c-tab__data">
                    <ul class="c-tab__data-item">
                        ...
                        <li class="c-tab__data-title"><a class="c-link" href="/zamki#mul_t_lock_omega_plus">Mul-t-Lock Omega Plus</a></li>
                    </ul>
                    <ul class="c-tab__data-item">
        ...
        <img class="c-tab__img" src="<?= SITE_TEMPLATE_PATH ?>/img/concept/2x/lock-brilliant.png" srcset="<?= SITE_TEMPLATE_PATH ?>/img/concept/1x/lock-brilliant.png 1x, <?= SITE_TEMPLATE_PATH ?>/img/concept/2x/lock-brilliant.png 2x"/>
    </div>
</li>