<div class="tabs_block js_tabs_block">
  <div class="dp-options dp-options_100u">
    ...
    <div class="dp-options__wrap">
      <div class="dp-options__main">
        ...
        <div class="dp-options__item">
          ...
          <div class="dp-options__item-title price_wrap">
            <p class="price">+ <span class="num">153 </span>руб.</p>
          </div>
        </div>
      </div>
      <div class="dp-options__aside">
        <div class="dp-options__manager"><img class="dp-options__manager-img" src="<?=SITE_TEMPLATE_PATH?>/img/cool/elis-2x.jpg" srcset="<?=SITE_TEMPLATE_PATH?>/img/cool/elis.jpg 1x, <?=SITE_TEMPLATE_PATH?>/img/cool/elis-2x.jpg 2x"/>
          <div class="dp-options__manager-say">
            <p class="dp-options__manager-say-item">Помогу определить оптимальную сторону открывания двери. Рассчитаю стоимость.</p>
          ...
          </div><span class="dp-options__manager-name">Елизавета, менеджер <br>по продажам</span>
        </div>
      </div>
    </div>
  </div>
