        ...
        <div class="dp-options__wrap">
            <div class="dp-options__main">
                ...
                <div class="dp-options__item">
                    ...
                    <p class="dp-options__item-desc price">
                        +27 руб. — коричневый или антрацит
                    </p> 
<p class="dp-options__item-desc price">
                        +41 руб. — белый или слоновая кость
                    </p>
                    <p class="dp-options__item-desc price">
                        +137 руб. — окраска коробки в 2 цвета
                    </p>
                </div>
                <div class="dp-options__item">
                    <p class="dp-options__item-title">
                    ...
                    <p class="dp-options__item-desc text">
                        ...
                        от&nbsp;внешней. Устраняет «мостики
                        холода», которые&nbsp;снижают показатели
                        теплозащиты, поэтому дверь со стороны
                        помещения остаётся тёплой и не промерзает
                        снаружи.
                    </p>
                    <p class="dp-options__item-desc price">
                        +137 руб.
